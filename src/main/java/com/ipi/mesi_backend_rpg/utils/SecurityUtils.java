// Fichier: src/main/java/com/ipi/mesi_backend_rpg/utils/SecurityUtils.java
...
public class SecurityUtils {
    ...
    /**
     * ✅ FIX: Récupère l'ID de l'utilisateur connecté depuis le contexte Spring
     * Security
     * ATTENTION: Cette méthode doit être NON-STATIC car elle utilise des
        ...
        try {
            ...
            if (authentication != null && authentication.isAuthenticated()) {
                ...
                if (principal instanceof UserDetails) {
                    ...
                    // ✅ FIX: Récupérer l'email depuis les détails de l'authentification
                    ...
                    if (email != null) {
                        ...
                        log.error("Email non trouvé dans les détails de l'authentification");
            ...
            // Relancer les exceptions de statut HTTP telles quelles
            throw e;
        } catch (Exception e) {
    ...
    public Long getCurrentUserIdFromWebSocket(StompHeaderAccessor headerAccessor) {
        try {
            // Dans votre WebSocketSecurityConfig, vous stockez l'ID utilisateur dans le
            // Principal
